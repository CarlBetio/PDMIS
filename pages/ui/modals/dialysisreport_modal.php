                                            ...
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                                    <div class="form-group">
                                                        <div class="form-line">
                                        <select class="form-control show-tick" data-live-search="true" name="patientid" id="patientid" title="&nbsp" onchange="myFunction(event)">
