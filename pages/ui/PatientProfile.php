                                            ...
                                            <form class="form-horizontal" form method="POST" action="save/savehemoorder.php?id=<?php if($HOfetch['order_id'] == '') echo $H_id." | "."001" ?><?php if($HOfetch['order_id'] != '') echo $H_id." | ".$HOfetch['order_id'] ?>">
                                                ...
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" name="frequencyothers" id="frequencyothers" value="<?php echo $HOfetch['freq_others']?>"  >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row clearfix">
                                                 <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 form-control-label">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ">
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text" class="form-control" name="durationothers" id="durationothers" value="<?php echo $HOfetch['dur_others']?>" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
